...
public class Inventory : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CurrentPlayer.InventoryRessources.CollectionChanged += UpdateRessourceLabels;
    }

    public void UpdateRessourceLabels(object sender, NotifyCollectionChangedEventArgs items)
    {
        var water = 0;
        var steel = 0;
        var wood = 0;
